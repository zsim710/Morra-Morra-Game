 ...
 List<Integer> prevfingers = new ArrayList<Integer>();
  ...
  public void play() {
    ...
    if(players.get(0).isValidfingers() && players.get(0).isValidsum()){
      MessageCli.PRINT_INFO_HAND.printMessage(players.get(0).getPlayerName(),players.get(0).getPlayerFingers(), players.get(0).getPlayerSum());
      break;
    }
    else{
  ...
  MessageCli.PRINT_INFO_HAND.printMessage("Jarvis", Integer.toString(cpufingers), Integer.toString(cpusum));
  ...
  public void showStats() {
    ...
    if(!gameisrunning){
      ...
      MessageCli.PRINT_PLAYER_WINS.printMessage(players.get(0).getPlayerName(), Integer.toString(humanpoints), Integer.toString(pointstowin - humanpoints));
      MessageCli.PRINT_PLAYER_WINS.printMessage("Jarvis", Integer.toString(aipoints), Integer.toString(pointstowin - aipoints));
    }
  }
}
